...
private static final long serialVersionUID = 0L;
  ...
  public static final int TEMPNEW_FIELD_NUMBER = 1;
  private volatile java.lang.Object tempNew_;
  /**
   * <code>string tempNew = 1;</code>
   */
  public java.lang.String getTempNew() {
    java.lang.Object ref = tempNew_;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getTempNewBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 1, tempNew_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!getTempNewBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1, tempNew_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    boolean result = true;
    result = result && getTempNew()
        .equals(other.getTempNew());
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + TEMPNEW_FIELD_NUMBER;
    hash = (53 * hash) + getTempNew().hashCode();
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(environmentService.TempResponse other) {
      ...
      if (!other.getTempNew().isEmpty()) {
        tempNew_ = other.tempNew_;
        onChanged();
      }
    ...
    private java.lang.Object tempNew_ = "";
    /**
     * <code>string tempNew = 1;</code>
     */
    public java.lang.String getTempNew() {
     ...
     * <code>string tempNew = 1;</code>
     */
    public Builder clearTempNew() {
      
      tempNew_ = getDefaultInstance().getTempNew();
      onChanged();
      return this;
    }
    /**
     * <code>string tempNew = 1;</code>
     */
    public Builder setTempNewBytes(
